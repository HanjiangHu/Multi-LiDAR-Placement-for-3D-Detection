...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    ...
    MIN_HEIGHT = [-100000, -100000, -100000] # [40, 25, 25]
    MAX_OCCLUSION = [0, 1, 2]
    ...
    for i in range(num_gt):
        ...
        if (gt_name == current_cls_name):
            ...
            # print("SHIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIT!", current_cls_name, gt_name)
            valid_class = -1
        ignore = False
...
def compute_statistics_jit(overlaps,
    ...
    for i in range(gt_size):
        ...
        # print("%%%%%%%%%%%%%%%%%%%%%%%%%%%%%", valid_detection, ignored_gt[i], ignored_det[det_idx])
...
def eval_class(gt_annos,
    ...
    for m, current_class in enumerate(current_classes):
        for l, difficulty in enumerate(difficultys):
            ...
            # print("#######################", current_class, gt_datas_list, dt_datas_list, ignored_gts, ignored_dets)
