...
class RouteScenario(BasicScenario):
    ...
    def _initialize_actors(self, config):
        ...
        ped_amount = pedestrian_amount[config.town] if config.town in pedestrian_amount else 0
        ...
        new_actors = CarlaDataProvider.request_new_batch_actors('vehicle.*',
                                                                ...
                                                                rolename='background')
        # the following part is with reference to https://github.com/carla-simulator/carla/blob/e73ad54d182e743b50690ca00f1709b08b16528c/PythonAPI/examples/spawn_npc.py#L179
        new_pedestrains = CarlaDataProvider.request_new_batch_actors('walker.pedestrian.*',
                                                                ped_amount,
                                                                carla.Transform(),
                                                                autopilot=False,
                                                                random_location=True,
                                                                rolename='background', walker=True)
        # if autopilot false: stuck walkers
