...
class AgentWrapper(object):
    ...
    def setup_sensors(self, vehicle, sensor_specs=None, debug_mode=False):
        """
        ...
        for sensor_spec in sensor_specs:
            ...
            self._sensors_transforms_list[sensor_spec['id']] = sensor_transform
            self._sensor_heights[sensor_spec['id']] = sensor_spec['z']
